...
package com.kongderui.ui.wheel;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF67b34f;
	...
	private void initData(Context context,AttributeSet attrs) {
	    if(attrs != null){
	        ...
	        ADDITIONAL_ITEM_HEIGHT = (int) array.getDimension(R.styleable.MyView_labelSize, 20);   //提供默认值，放置未指�?  
	        System.out.println("ADDITIONAL_ITEM_HEIGHT----->"+ADDITIONAL_ITEM_HEIGHT);
	        TEXT_SIZE  = (int)array.getDimension(R.styleable.MyView_textSize, 24); 
	...
	private void initResourcesIfNecessary() {
		...
		setBackgroundResource(R.drawable.shape_info_tv_nor);
	}
